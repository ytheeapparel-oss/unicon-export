...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "DC.subject": "Leather Goods Manufacturer India, Leather Bags Manufacturer India, Leather Bags Manufacturer India for European Brands, Leather Bags Manufacturer India for Australian Brands, Private Label Leather Goods Manufacturer, Custom Leather Goods Manufacturer India, Leather Goods Exporter India, Wholesale Leather Bags India, OEM Leather Goods Manufacturer",
    "DC.description": "Premier leather goods and leather bags manufacturer in India for European and Australian fashion brands. Custom OEM/ODM private-label factory in Noida, Delhi NCR, and Kolkata.",
    "DC.publisher": "Unicon Leather Goods Export Private Limited",
    "DC.language": "en",
    "DC.coverage": "Worldwide, United States, United Kingdom, European Union, Australia, Germany, France, Italy, India, Delhi NCR, Noida",
